...
const int red_led_pin=8; //NOT OK led
const int green_led_pin=9; //OK led
const int dc_coef=229;// dc=mean/dc_coef
//end setup
...
if(digitalRead(manual_switch_pin)==0){ //manual mode on
